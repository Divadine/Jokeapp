...
import 'package:jokes_app/JokeApp/Screens/favourite_screen.dart';
...
import 'package:jokes_app/JokeApp/Screens/favourite_screen.dart';
enum CatType { riddles, one_line_joke, philosophy }
...
class _Screen2HomePageState extends State<Screen2Homepage> {
  ...
  final sliderTypes = ["riddles", "one line joke", "philosophy", "philosophy"];
                            ...
                            onTap: () {
                              if (type == "conversation") {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => ConversationCategoryScreen(),
                                  ),
                                );
                              } else {
                                Navigator.push(
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: currentIndex == index
                              ? AppUtils.primary
                              : AppUtils.primary.withOpacity(0.3),
                  ...
                  Padding(
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        _buildCategory(
                          "philosophy",
                          "assets/images/slide1_0_img.jpg",
                        ),
                        _buildCategory(
                          "one line joke",
                          "assets/images/slide1_img.jpg",
                        ),
                        _buildCategory(
                          "riddles",
                          "assets/images/slide2_img.jpg",
                        ),
                        _buildCategory(
                          "conversation",
                          "assets/images/slide2_img.jpg",
    ...
    return GestureDetector(
      onTap: () {
        if (title == "philosophy") {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => ConversationCategoryScreen()),
          );
        }
      },
      child: Container(
